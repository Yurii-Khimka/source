...
export function RightRail() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      >
        <div><Link href="/about" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>About</Link> · <Link href="/feedback" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>Feedback</Link> · <Link href="/support" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>Support</Link> · <Link href="/privacy" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>Privacy</Link> · <Link href="/terms" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>Terms</Link> · <Link href="/trust" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>Standards</Link> · <a href="https://github.com/Yurii-Khimka/source" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ color: dark.textMute, textDecoration: "none" }}>GitHub</a></div>
